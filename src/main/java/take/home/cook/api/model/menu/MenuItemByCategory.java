 ...
 */
public class MenuItemByCategory {
    @PrimaryKeyClass
    public static class Key {
        ...
        @PrimaryKeyColumn(name="item_id" , ordinal = 2 )
        private UUID itemId;

        @PrimaryKeyColumn(name="item_added" , ordinal = 3)
        private Date itemAdded;


        public Key(String id, UUID userId, UUID itemId, Date itemAdded) {
            this.id = id;
            this.userId = userId;
            this.itemId = itemId;
    ...
    public MenuItemByCategory() {
    }

    public MenuItemByCategory(Key key, String picture, String name, String description, boolean available, Set<String> categories, Set<String> remarks, Set<String> tags) {
        this.key = key;
    ...
    public MenuItemByCategory(Key key , MenuItem menuItem) {
        this.key = key;
